<%-- 
    Document   : EditarApoderado
    Created on : 4 dic 2022, 1:08:42
    Author     : kioto
--%>
        ...
        <div class="col-sm-12 col-md-2 col-lg-4 col-xl-4 py-4 bg-white ">
          ...
          <form action="Controlador?menu=Apoderado" method="POST">
            <div class="mb-3">
              ...
              <input type="text" name="txtAId" class="form-control" id="nombre"  autofocus value="${apoderadoSeleccionado.getId_apoderado()}"/>
            </div>
            <div class="mb-3">
