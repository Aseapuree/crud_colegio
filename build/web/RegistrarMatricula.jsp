<%-- 
    Document   : RegisstrarMatricula
    Created on : 4 dic 2022, 1:43:29
    Author     : kioto
--%>
        ...
        <div class="col-sm-12 col-md-2 col-lg-4 col-xl-4 py-4 bg-white  ">
          ...
          <form action="Controlador?menu=Principal" method="POST">
            <div class="mb-3">
              ...
              <input type="text" name="txtCodigo" class="form-control" id="nombre"  autofocus />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="txtNombres"  class="form-control" id="nombre" autofocus />
            </div>
            <div class="mb-3">
              <label for="programadores" class="form-label">Apellido Paterno</label>
              <input type="text" name="txtApellidoPaterno" class="form-control" id="programadores" />
            </div>
            <div class="mb-3">
              <label for="programadores" class="form-label">Apellido Materno</label>
              <input type="text" name="txtApellidoMaterno" class="form-control" id="programadores" />
            </div>
         
            <div class="mb-3">
              <label for="programadores" class="form-label">Edad</label>
              <input type="text" name="txtEdad" class="form-control" id="programadores"/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="txtTelefono" class="form-control" id="programadores" />
            </div>
            <div class="mb-3">
